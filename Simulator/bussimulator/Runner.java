...
public class Runner implements Runnable {
	...
	public static int initBussen(){
		addBus(3, new Bus(Lijnen.LIJN1, Bedrijven.ARRIVA, 1));
		addBus(5, new Bus(Lijnen.LIJN2, Bedrijven.ARRIVA, 1));
		addBus(4, new Bus(Lijnen.LIJN3, Bedrijven.ARRIVA, 1));
		addBus(6, new Bus(Lijnen.LIJN4, Bedrijven.ARRIVA, 1));
		addBus(3, new Bus(Lijnen.LIJN5, Bedrijven.FLIXBUS, 1));
		addBus(5, new Bus(Lijnen.LIJN6, Bedrijven.QBUZZ, 1));
		addBus(4, new Bus(Lijnen.LIJN7, Bedrijven.QBUZZ, 1));
		addBus(6, new Bus(Lijnen.LIJN1, Bedrijven.ARRIVA, 1));
		addBus(12, new Bus(Lijnen.LIJN4, Bedrijven.ARRIVA, 1));
		addBus(10, new Bus(Lijnen.LIJN5, Bedrijven.FLIXBUS, 1));
		addBus(3, new Bus(Lijnen.LIJN8, Bedrijven.QBUZZ, 1));
		addBus(5, new Bus(Lijnen.LIJN8, Bedrijven.QBUZZ, 1));
		addBus(14, new Bus(Lijnen.LIJN3, Bedrijven.ARRIVA, 1));
		addBus(16, new Bus(Lijnen.LIJN4, Bedrijven.ARRIVA, 1));
		addBus(13, new Bus(Lijnen.LIJN5, Bedrijven.FLIXBUS, 1));
		addBus(3, new Bus(Lijnen.LIJN1, Bedrijven.ARRIVA, -1));
		addBus(5, new Bus(Lijnen.LIJN2, Bedrijven.ARRIVA, -1));
		addBus(4, new Bus(Lijnen.LIJN3, Bedrijven.ARRIVA, -1));
		addBus(6, new Bus(Lijnen.LIJN4, Bedrijven.ARRIVA, -1));
